...
export const defaultEditorOptions: monaco.editor.IStandaloneEditorConstructionOptions =
  {
    ...
    // Line settings
    lineNumbers: "on", // ✅ valid: "on" | "off" | "relative" | "interval" | fn
    lineHeight: 20,
    ...
    tabCompletion: "on",
    wordBasedSuggestions: "allDocuments", // ✅ string literal instead of boolean
    quickSuggestions: {
      other: true,
      comments: false,
      strings: false,
    ...
    cursorSmoothCaretAnimation: "on", // ✅ must be "on" | "off" | "explicit"
    cursorStyle: "line",
    cursorWidth: 2,
